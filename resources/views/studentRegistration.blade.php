...
<div class="d-flex justify-content-center m-5">
    <div class="card" style="width: 25rem;">
        <div class="card-title d-flex justify-content-center h3 m-2">Students Registration</div>
        <div class="card-body">
            ...
            <div class="row">
                <a href="{{ route('studentLogin') }}" class="d-flex justify-content-center">Already have account?</a>
            </div>
            <div class="row">
