...
<div class="d-flex justify-content-center m-5">
    <div class="card" style="width: 25rem;">
        <div class="card-title d-flex justify-content-center h3 m-2">Teachers Login</div>
        <div class="card-body">
            ...
            <div class="row">
                <a href="{{ route('teacherRegistration') }}" class="d-flex justify-content-center">dont have account?</a>
            </div>
            <div class="row">
